...
class Languages implements \IteratorAggregate
{
    ...
    /**
     * Returns a list of all languages in ISO 639-1
     *
     * @return Language[]
     */
    ...
    /**
     * Finds a language by its ISO-639-1 code (two letters)
     *
     * @param string $code
     *
     * @return Language
    ...
    /**
     * Finds a language by its ISO-639-2/T code (three letters)
     *
     * @param string $code
     *
     * @return Language
    ...
    /**
     * Finds a language by its ISO-639-2/B code (three letters)
     *
     * @param string $code
     *
     * @return Language
    ...
    /**
     * Finds a language by its ISO-639-3 code (three letters)
     *
     * @param string $code
     *
     * @return Language
    ...
    /**
     * Finds a language by its English name
     *
     * @param string $name
     *
     * @return Language
    ...
    /**
     * Finds a language given the property index and value
     *
     * @param int $index
     * @param string $value
     *
